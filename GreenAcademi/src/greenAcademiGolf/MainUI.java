...
public class MainUI extends WindowAdapter implements ActionListener {
	...
	private Button ff_bLogin, ff_bJoin, ff_bFind, bt2_bCancel, bt2_bLogin, jf_bJoin, jf_bLogin, sf_bFindID, sf_bFindPwd,
	...
	private Label bt2_lID, bt2_lPwd, jf_lJoin, jf_lID, jf_lName, jf_lEmail, jf_lPwd, jf_lRepwd, sf_pID_lName,
			sf_pID_lEmail, sf_pPwd_lID, sf_pPwd_lEmail, d1_lMsg1, d2_lSuccess, d2_lFail, mf_pH_lTitle;
	...
	private Dialog d1_LoginFail, d2_joinSuccess, d2_joinFail;
	...
	MainUI() {
		...
		joinFrame.setLayout(new GridLayout(13, 0));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals(bt2_bLogin.getLabel())) {
			if (bt2_tID.getText().equals("asdasd") && bt2_tPwd.getText().equals("asdasd")) {
				System.out.println("Login success -> main page");
		...
		if (e.getActionCommand().equals(jf_bJoin.getLabel())) {
			if (jf_tID.getText().equals("asdasd")) {
				System.out.println("Join->DB connect");
				d2_joinSuccess.setVisible(true);
			} else {
				d2_joinFail.setVisible(true);
			}
		}
